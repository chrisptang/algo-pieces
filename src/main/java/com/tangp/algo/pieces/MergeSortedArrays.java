...
public class MergeSortedArrays {
     ...
     * <p>
     * 存在的问题：性能问题，最坏的情况将发生n(n-1)/2次移动，时间复杂度为O(n*n);最好的情况仅需移动N次；
     *
     * @param arrA
     * @param arrB
     * @return
    ...
    public static int[] merge(int[] arrA, int[] arrB) {
        if (arrA == null || arrB == null || arrA.length * 2 != arrB.length) {
            throw new IllegalArgumentException("You might want to chec k inputs.");
        }
     ...
     * <p>
     * 算法总共需要移动 2 * arrA.length次；性能较实现1有大幅提高；
     *
     * @param arrA
     * @param arrB
     * @return
